...
| 09-22 | [decision-index](decision-index.md) | Run the full 132,422-request Decision Index suite on Reflex 27B with two option orders, eight H100 replicas and 32 cold-request workers. | **56.23 Decision Index**, above the kit's Jev reference at 55.74; 117,922 successful, 14,500 declared >26-option refusals, zero errors, 93.73% weighted coverage, 1 h 23 m wall time. Exact harness, serving configuration, hashes and score artifacts are committed under `scripts/decision_index/`. |
