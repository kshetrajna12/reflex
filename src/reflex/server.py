...
def _sglang_backend(args):
    ...
    this process (an adapter, a thinking readout, the escalation cascade, prompt
    ensembles) is rejected here rather than quietly ignored.
    """
    ...
    for flag, value in (
        ...
        ("--think-if-disagree", args.think_if_disagree),
    ):
        if value:
